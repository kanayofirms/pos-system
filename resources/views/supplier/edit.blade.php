                                ...
                                <div class="card-body">
                                    <div class="row mb-3"> <label class="col-sm-2 col-form-label">Supplier Name</label>
                                        <div class="col-sm-10"> <input type="text"
                                                value="{{ $getRecord->supplier_name }}" class="form-control"
                                    ...
                                    <div class="row mb-3"> <label class="col-sm-2 col-form-label">Supplier Telephone</label>
                                        <div class="col-sm-10"> <input type="number"
                                                value="{{ $getRecord->supplier_telephone }}" name="supplier_telephone"
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea name="supplier_address" class="form-control" placeholder="Enter Supplier Address" required>{{ $getRecord->supplier_address }}</textarea>
